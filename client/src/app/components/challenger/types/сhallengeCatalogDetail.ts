...
export const MOCK_CHALLENGE_CORRECTION: ChallengeDetailCatalogCorrection[] = [
  {
    id: '1',
    title: 'Коррекция нагрузки при трудностях',
    subtitle: 'Адаптация программы под ваше самочувствие',
    warningLevel: 'medium',
    strategies: [
      {
        icon: '🔁',
        title: 'Уменьшение повторений',
        description: 'Сократите количество повторений до комфортного уровня',
        intensity: 2,
        conditions: ['Легкая усталость', 'Небольшой дискомфорт']
      },
      {
        icon: '⏱️',
        title: 'Увеличение времени отдыха',
        description: 'Увеличьте паузы между подходами и упражнениями',
        intensity: 1,
        conditions: ['Одышка', 'Высокий пульс', 'Мышечная усталость']
      },
      {
        icon: '⚡',
        title: 'Облегченные варианты',
        description: 'Используйте упрощенные версии упражнений',
        intensity: 3,
        conditions: ['Боль в суставах', 'Технические трудности']
      },
      {
        icon: '🕒',
        title: 'Сокращение длительности',
        description: 'Уменьшите общее время тренировки',
        intensity: 4,
        conditions: ['Сильная усталость', 'Нехватка времени', 'Плохое самочувствие']
      },
      {
        icon: '🏖️',
        title: 'Дополнительный отдых',
        description: 'Добавьте лишний день восстановления',
        intensity: 5,
        conditions: ['Перетренированность', 'Болезнь', 'Стресс']
      },
      {
        icon: '🎯',
        title: 'Фокус на технике',
        description: 'Сконцентрируйтесь на качестве выполнения, а не количестве',
        intensity: 2,
        conditions: ['Плохая техника', 'Риск травмы']
      }
    ],
    recommendations: [
      {
        text: 'Слушайте свое тело и не увеличивайте нагрузку слишком быстро',
        type: 'important'
      },
      {
        text: 'Не пропускайте разминку и заминку - они предотвращают травмы',
        type: 'warning'
      },
      {
        text: 'Следите за пульсом - он не должен превышать 80% от максимума',
        type: 'tip'
      },
      {
        text: 'При сильной боли немедленно прекратите тренировку',
        type: 'warning'
      },
      {
        text: 'Пейте воду во время тренировки для поддержания гидратации',
        type: 'tip'
      }
    ],
    emergencyActions: [
      {
        situation: 'Резкая боль в суставах или мышцах',
        action: 'Немедленно прекратите упражнение, приложите лед',
        immediate: true
      },
      {
        situation: 'Головокружение или тошнота',
        action: 'Сядьте или лягте, выпейте воды, измерьте давление',
        immediate: true
      },
      {
        situation: 'Одышка, не проходящая после отдыха',
        action: 'Прекратите тренировку, обратитесь к врачу',
        immediate: true
      }
    ]
  },
  {
    id: '2',
    title: 'Коррекция в йоге',
    warningLevel: 'low',
    strategies: [
      {
        icon: '🧘',
        title: 'Использование пропсов',
        description: 'Применяйте блоки, ремни и болстеры для поддержки',
        intensity: 2,
        conditions: ['Недостаточная гибкость', 'Дискомфорт в асанах']
      },
      {
        icon: '🌀',
        title: 'Укороченные последовательности',
        description: 'Сокращайте количество асан в практике',
        intensity: 3,
        conditions: ['Усталость', 'Нехватка времени']
      }
    ],
    recommendations: [
      {
        text: 'Не форсируйте асаны - практикуйте в комфортной амплитуде',
        type: 'important'
      }
    ]
  }
